...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2020 at 07:23 PM
...
(11, 29, 'Project', 1, 0, 'This Content Management system is created with PHP and MySQL databases also with the help of languages like HTML CSS and javascript. \r\nThe system is consisting of 2 areas one is\r\n Public (the general area where users can view the items) and the Administrator are (the administrative area where \r\nonly authorized users can access and maintain the information on subjects and pages which are stored in the backend MySQL database).');
